...
namespace InsaneOne.Core.Editor
{
    public static class SetupProjectPaths
    {
        public const string RepoName = "OlegDzhuraev";

        public static List<LinkHolder> GitPackages = new ()
        {
            ...
            new LinkHolder { Name = "Serialize Reference Drawer", Link = "https://github.com/OlegDzhuraev/Unity-SerializeReferenceExtensions.git?path=Assets/InsaneOne/InsaneOne.SerializeReferenceExtensions" },
#if !UNITY_6000_3_OR_NEWER // toolbar code changed a lot (starting from this version)
            ...
            new LinkHolder { Name = "Bookmark everything", Link = "https://github.com/OlegDzhuraev/bookmark-everything.git?path=BookmarkEverything/Assets/BookmarkEverything" },
        };

        public static List<LinkHolder> Packages = new ()
        {
            new LinkHolder { Name = "Input System", Link = "com.unity.inputsystem" },

#if !UNITY_6000_0_OR_NEWER
            new LinkHolder { Name = "Post Effects", Link = "com.unity.postprocessing" }, // not more actual since URP/HDRP
#endif
        ...
        public static List<LinkHolder> AssetLinks = new ()
        {
